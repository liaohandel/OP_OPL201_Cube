...
var campos = "C907" //web cam 8007
//var setdeviceport = 'C906'
var setuuid = '1234567890abcdefghijk'

//const ls = spawn('ls', ['-lh', '/usr']);

var bin =  '/home/pi/opcom_prj/gotest2_linkbox/llngrok' + (platform === 'win32' ? '.exe' : '');
...
const rrngrok = spawn( '/home/pi/opcom_prj/gotest2_linkbox/llngrok', ['-config=/home/pi/opcom_prj/gotest2_linkbox/ngrok.cfg','--log=stdout', '192.168.5.107:8007']);
			...
			rrngrok.stdout.on('data', function (data) {
				...
				if(addr){
					if(xxurl!=addr[0]){
						...
						//setddsnurl = devloadurl+'?UUID='+setuuid+'&DevicePort='+setdeviceport+'&DeviceIP='+seturl
